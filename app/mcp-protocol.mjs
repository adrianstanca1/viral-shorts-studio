...
{name:'opportunity_scan',description:'Run a multi-mode source-grounded opportunity scan.',inputSchema:{type:'object',required:['query'],properties:{query:{type:'string'}}}},
