...
export function voiceCatalog(root){const state=read(root),fav=new Set(state.favourites||[]);return catalog.map(x=>({...x,favourite:fav.has(x.id),previewAvailable:true,policy:'local-free'}));}
