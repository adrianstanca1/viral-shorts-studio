...
const server=read('app/server.mjs'),pipeline=read('app/pipeline.mjs'),plan=read('V3_DEVELOPMENT_PLAN.md'),v4=read('V4_DEVELOPMENT_PLAN.md'),v5=read('V5_DEVELOPMENT_PLAN.md'),v6=read('V6_DEVELOPMENT_PLAN.md'),score=read('COMPETITIVE_SCORECARD.md');
const checks=[
